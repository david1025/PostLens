  ...
  void _escape() {
    setState(() {
      try {
        ...
        _rightController.text = 'Error escaping: $e';
      }
    });
  }
  ...
  void _unescape() {
    setState(() {
      try {
        ...
        _leftController.text = 'Error unescaping: $e';
      }
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    return DualPaneToolWidget(
      ...
      centerControls: Row(
        ...
        children: [
          ToolButton(onPressed: _escape, icon: Icons.arrow_downward, label: 'Escape'),
          const SizedBox(width: 16),
          ToolButton(onPressed: _unescape, icon: Icons.arrow_upward, label: 'Unescape'),
        ],
      ),
    );
  }
