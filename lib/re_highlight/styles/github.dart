...
const githubTheme = {
  ...
  'attr': TextStyle(
      color: Color(
          0xff8b1f23)), // Object keys (like "userId") changed to red-brown
  'attribute': TextStyle(color: Color(0xff8b1f23)),
  'literal': TextStyle(
      color: Color(0xff1a45a3),
      fontWeight: FontWeight
          .bold), // boolean/null, changed to darker blue bold as requested
  'meta': TextStyle(color: Color(0xff005cc5)),
  'number':
      TextStyle(color: Color(0xff188038)), // changed to green-like as requested
  ...
  'string':
      TextStyle(color: Color(0xff235ca2)), // changed to blue-like as requested
  'meta-string': TextStyle(color: Color(0xff235ca2)),
